...
import com.duwss.apibackend.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.duwss.apibackend.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.duwss.apibackend.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
...
public class InterfaceController {
    ...
    @Resource
    private com.duwss.apibackend.service.InterfaceInfoService interfaceInfoService;
...
//        queryWrapper.like(StringUtils.isNotBlank(content), "content", content);
    ...
    /**
     * 远程调用接口返回接口信息，根据path和method
     * @param path
     * @param method
     * @return
     */
    @GetMapping("/remoteinterfaceinfo")
    public BaseResponse remoteinterface(@RequestParam("path") String path,@RequestParam("method") String method){
           return interfaceInfoService.getInfoByPath(path,method);
    }
