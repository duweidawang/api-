...
public class UserController {
    ...
    @GetMapping()
    public String test(HttpServletRequest request, HttpServletResponse response,@RequestParam String name){
        //获取请求方式
        ...
        System.out.println("请求访问路径"+contextPath);
     ...
     * @return
     */
    @GetMapping("/getinterfaceUser")
    public BaseResponse<com.duwss.common.model.entity.User> getUser(@RequestParam("accessKey")  String accessKey){
        System.out.println(accessKey);
      log.info("laidao;l");

        User user = userService.getInterByac(accessKey);
      com.duwss.common.model.entity.User user1 = new com.duwss.common.model.entity.User();
      BeanUtils.copyProperties(user,user1);

      return new BaseResponse<com.duwss.common.model.entity.User>(200,user1);
